...
export const StoreInformationPage = styled.div`
  max-width: 1440px;
  margin: 0 auto;
  display: flex;
...
export const StepText1 = styled.p`
  ...
  &:nth-of-type(1)::after {
    ...
    width: 2px;
    height: 150px; /* Length of the dotted line */
...
export const WhatsAppOptionsWrapper = styled.div`
  margin-top: 20px;
`;
...
export const WorkingDaysHeader = styled.div`
  display: flex;
...
export const UploadTextSpan = styled.span`
  font-weight: 600;
  color: #868c9a;
  display: block;
  margin-bottom: 5px;
...
// Responsive Design
export const ResponsiveStoreInformationContainer = styled(
